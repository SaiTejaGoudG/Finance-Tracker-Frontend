...
// Cookie set by the FRONTEND (AuthContext) on login/signup to signal an active
// session to this middleware. We cannot use the backend's refreshToken cookie
...
export function proxy(request: NextRequest) {
  ...
  // session presence via the frontend-owned session flag cookie.
