...
const config: Config = {
  ...
  content: [
    ...
    // lib/ holds class-name maps (see lib/tx-meta.ts). Without this glob those
    // classes are purged from the bundle and render as unstyled.
    './lib/**/*.{js,ts,jsx,tsx}',
    ...
    extend: {
      ...
      colors: {
        ...
        chart: {
          ...
          // Plot-area panel. Blue-tinted in dark mode, matching the original
          // `dark:bg-gray-900` (Tailwind gray is not neutral — hsl 221 39% 11%).
      ...
      boxShadow: {
        // Functional elevation only — no decorative drop shadows
